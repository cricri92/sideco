	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
			  	<h4 class="panel-title">Nueva agenda</h4>
			</div>
			<div class="panel-body">
				<div class="col-md-6">
					<div class="form-group">
						<label for="exampleInputEmail1"><div class="header-title"><h2><small>Información de la agenda</small></h2></div></label>
					</div>
		  			...
		  			<!--<div class="control-group">
		    			...
		    			<div class="form-group">
					  	...
					  	<div class="form-group">
					    	...
					    	<input type="text" class="form-control" name="num_acta" placeholder=""/>
				...
				<label for="exampleInputEmail1"><div class="header-title"><h2><small></small></h2></div></label>
				<div class="col-md-6">
